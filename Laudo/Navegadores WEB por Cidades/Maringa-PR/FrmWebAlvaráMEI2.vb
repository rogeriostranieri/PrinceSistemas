Public Class FrmWebAlvaráMEI2
    Private Sub FrmWebAlvaráMEI2_FormClosed(sender As Object, e As FormClosedEventArgs) Handles Me.FormClosed
        WebView21.Dispose()
    End Sub
    ...
    Private Sub FrmWebAlvaráMEI2_Load(sender As Object, e As EventArgs) Handles MyBase.Load
