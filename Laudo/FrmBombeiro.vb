Public Class FrmBombeiro

    Private Sub FrmBombeiro_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        Me.Refresh()
        ' LaudosBindingSource.Filter = "BombeirosSituacao = 'Não Iniciado'  Or  situacao = 'Aguardando Pagamento'  Or  situacao = 'Em Andamento'  Or  situacao = 'Pendência' "
    ...
    Private Sub Button2_Click(sender As Object, e As EventArgs) Handles Button2.Click
        ...
        LaudosBindingSource.Filter = "BombeiroSituacao = '" & FilterA & " ' "
