Public Class DialogAjudaTipoUnidade
    ...
    Private Sub DialogAjudaTipoUnidade_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        'How to convert from text to RTF
    End Sub
    ...
    Private Sub DialogAjudaTipoUnidade_FormClosing(sender As Object, e As FormClosingEventArgs) Handles MyBase.FormClosing
        Salvar()
    End Sub
End Class
