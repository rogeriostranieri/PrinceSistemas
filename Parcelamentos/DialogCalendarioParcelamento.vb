...
Public Class DialogCalendarioParcelamento
    Public campoDestino As MaskedTextBox
    ...
    Private Sub Calendar1_DateSelected(sender As Object, e As DateRangeEventArgs) Handles Calendar1.DateSelected
        If campoDestino IsNot Nothing Then
            campoDestino.Text = Calendar1.SelectionStart.ToString("dd/MM/yyyy HH:mm")
        End If
        Me.Close()
    End Sub
