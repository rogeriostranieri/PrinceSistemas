Public Class RlTipoEmpresa

    Private Sub RlTipoEmpresa_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        ...
        EmpresasBindingSource.Filter = "TipoDeEmpresa = 'Sociedade Empresária Limitada ( Ltda. )' AND TipoDeEmpresa = 'Empresa Individual de Responsabilidade Limitada ( Eireli )'AND TipoDeEmpresa = 'Empresa individual(RE)' AND TipoDeEmpresa = 'Microempreendedor Indivual(MEI)' AND TipoDeEmpresa = 'Sociedade Anônima(SA)' AND TipoDeEmpresa = 'Sociedade Simples' "
...
TipoDeEmpresa = 'Sociedade Empresária Limitada ( Ltda. )' 
AND TipoDeEmpresa = 'Empresa Individual de Responsabilidade Limitada ( Eireli )'
AND TipoDeEmpresa = 'Empresa individual(RE)' 
AND TipoDeEmpresa = 'Microempreendedor Indivual(MEI)' 
AND TipoDeEmpresa = 'Sociedade Anônima(SA)' 
AND TipoDeEmpresa = 'Sociedade Simples' 
"
    End Sub
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        EmpresasBindingSource.Filter = "TipoDeEmpresa = '" & FilterA & " ' "
