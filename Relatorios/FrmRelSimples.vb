Public Class FrmRelSimples


    Private Sub FrmRelSimples_Load(sender As Object, e As EventArgs) Handles MyBase.Load
    ...
    Private Sub Button1_Click(sender As Object, e As EventArgs) Handles Button1.Click
        ...
        If ComboBox1.Text <> "TODAS" Then
            ...
            EmpresasBindingSource.Filter = "RegimeFederal = '" & FilterA & " ' "
        Else
            'TODO: esta linha de código carrega dados na tabela 'PrinceDBDataSet.Empresas'. Você pode movê-la ou removê-la conforme necessário.
